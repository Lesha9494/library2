 ...
 */
class getActionLogRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActionLogRepository' shared autowired service.
     *
     * @return \App\Repository\ActionLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActionLogRepository.php';

        return $container->privates['App\\Repository\\ActionLogRepository'] = new \App\Repository\ActionLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
